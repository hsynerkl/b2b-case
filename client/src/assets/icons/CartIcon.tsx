...
export const CartIcon = ({ size = 20, className }: IconProps) => {
  return (
    <svg width={size} height={size} className={className} viewBox="0 0 20 20">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      />
      <path d="M3.49 2H2a1 1 0 0 1 0-2h2.29a1 1 0 0 1 .975.78l2.71 12a1 1 0 1 1-1.95.44zM10 17.25a1.75 1.75 0 1 1-3.5 0 1.75 1.75 0 0 1 3.5 0m7 0a1.75 1.75 0 1 1-3.5 0 1.75 1.75 0 0 1 3.5 0" />
    </svg>
  );
};
